...
public class UIWidget : UIRect
{
	...
	public void CheckLayer ()
	{
		...
		{
            // CEP Modification: avoid lag, these logs are quite resource heavy
#if UNITY_EDITOR
			Debug.LogWarning(string.Format("You can't place widget {0} on a layer {1} different than the UIPanel {2}, {3} that manages them.\n" +
				"If you want to move widgets to a different layer, parent them to a new panel instead.", gameObject.name, gameObject.layer, panel.gameObject.name, panel.gameObject.layer), this);
#endif
